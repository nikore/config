{ config, pkgs, inputs, lib, ... }: {
  ...
  programs.zen-browser = {
    enable = true;
    package = lib.mkForce
      (config.lib.nixGL.wrap inputs.zen-browser.packages.x86_64-linux.twilight);
    ...
    profiles."default" = {
      ...
      search = {
        ...
        engines = {
          "nix options" = {
            urls = [{
              template =
                "https://search.nixos.org/options?type=options&query={searchTerms}";
            }];
      ...
      settings = {
        ...
        "app.normandy.first_run" =
          false; # Disable Normandy/Shield telemetry system
        ...
        "browser.aboutConfig.showWarning" =
          false; # Don't warn when opening about:config
        "browser.contentblocking.category" =
          "strict"; # Use strict content blocking
        "browser.ctrlTab.recentlyUsedOrder" =
          false; # Switch tabs in order, not by recency
        ...
        "browser.tabs.allow_transparent_browser" =
          true; # Allow background transparency
        "browser.tabs.newtabbutton" =
          false; # Don't show new tab button in tab bar
        "browser.tabs.hoverPreview.enabled" = true; # Enable tab hover preview
        "browser.sessionstore.restore_pinned_tabs_on_demand" =
          true; # Restore pinned tabs to their original URL
        ...
        "browser.urlbar.quickactions.enabled" =
          false; # Disable URL bar quick actions
        ...
        "datareporting.policy.dataSubmissionEnable" =
          false; # Disable data submission
        ...
        "privacy.trackingprotection.enabled" =
          true; # Enable tracking protection
        "privacy.trackingprotection.socialtracking.enabled" = true;
        "privacy.webrtc.legacyGlobalIndicator" =
          false; # Disable WebRTC sharing indicator

        # Container tabs
        "zen.containers.enable_container_essentials" =
          true; # Enable container-specific essentials
        ...
        "extensions.bitwarden.alwaysShowPanel" =
          true; # Always show Bitwarden for filling
        ...
        "widget.dmabuf.force-enabled" =
          true; # Enable dmabuf (required for Wayland)
  ...
  xdg = {
    ...
    mimeApps = let
      associations = builtins.listToAttrs (map (name: {
        inherit name;
        value =
          let zen-browser = inputs.zen-browser.packages.${pkgs.system}.twilight;
          in zen-browser.meta.desktopFile;
      }) [
